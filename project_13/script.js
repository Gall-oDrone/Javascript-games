window.addEventListener('load', function(){
    ...
    class Particle {
        ...
        draw(){
            ...
            this.effect.contect.fillRect(this.originX, this.originY, this.size, this.size);
        }
        update(){
            ...
            if (this.distance < this.effect.mouse.radius){
                ...
                this.vx += this.firce * Math.cos(this.angel);
            }
            this.x += (this.vx *= this.frction) + (this.originX - this.x) * this.ease;
    ...
    class Effect {
        constructor(context, canvasWidth, canvasHeight){
            ...
            this.fontSize = 80;
            this.lineHeight = this.fontSize * 80;
