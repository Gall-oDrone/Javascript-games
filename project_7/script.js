    ...
    class InputHandler {
        constructor(){
            ...
            window.addEventListener('touchmove', e => {
                const swipedDistance = e.changedTouches[0].pageY - this.touchY;
                if (swipedDistance <- this.touchTreshhold && this.keys.indexOf('swipe up') === -1) this.keys.push('swipe up');
                else if (swipedDistance > this.touchTreshhold && this.keys.indexOf('swipe down') === -1) {
